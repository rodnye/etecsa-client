 ...
 */
export const createGetMobileServiceStatus = (context: EtecsaClientContext) => {
  const profileApi = createProfileApi(context);
  ...
  return async (
    ...
    return mobileServicesRequest<GetServiceStatusResponse>(context, {
